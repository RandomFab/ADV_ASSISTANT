...
print(f"DEBUG: DATABASE_URL generated (password hidden): postgresql://{os.getenv('POSTGRES_USER')}:****@{os.getenv('POSTGRES_HOST', 'localhost')}:{os.getenv('POSTGRES_PORT', '5432')}/{os.getenv('POSTGRES_DB')}")
